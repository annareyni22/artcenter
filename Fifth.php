...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style35">
                                <?php  echo date("d/m/y"); ?><asp:Label ID="lblDate" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style38">
                               500 Rs.<asp:Label ID="lblAmoubnt" runat="server"></asp:Label>
                                <strong>/-</strong></td>
                        </tr>
                        <tr>
                            <td class="auto-style36">Transaction ID</td>
                            <td class="auto-style37"></td>
                            <td class="auto-style38"> 115223999 <asp:Label ID="lblTID" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr><td colspan="3" ><a href="UserMakePayment.php"><input type="button" value="ok">  </a></td>
            </tr>
            <tr>
