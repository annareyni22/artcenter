...
<div id="about" class="about">
	...
	<div style="margin: auto; width: 60%;">
		<!-- ....................  -->
		 ...
		 <?php
    $qry = "SELECT * FROM `user_registration` u,`bookings` b,`artist_registration` a ,`artist_portfolio` p WHERE a.`aid`=p.`aid`AND a.`aid`=b.`aid` AND b.`uid`=u.`uid` AND   b.`booking_status`='approved' AND u.`uid`='" . $_SESSION['uid'] . "'";
