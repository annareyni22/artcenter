...
<div id="about" class="about">
	<div class="container">
		<h3 class="title wow fadeInUp animated" data-wow-delay=".5s">Venue Bookings</h3>
	...
	<div style="margin: auto; width: 80%;">
		...
		<?php
		$qry = "SELECT * FROM `user_registration` u,`venue_bookings` vb,`venue_registration` v WHERE  v.`vid`=vb.`vid` AND vb.`uid`=u.`uid` AND   vb.`booking_status`='approved'-'pending' AND u.`uid`='" . $_SESSION['uid'] . "'";
