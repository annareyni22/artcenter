...
<div id="about" class="about">
	...
	<div style="margin: auto; width: 90%;">
		<!-- ....................  -->
		<?php
		$qry = "SELECT * FROM `user_registration` u,`venue_bookings` vb,`venue_registration` v  WHERE  v.`vid`=vb.`vid` AND vb.`uid`=u.`uid` AND   vb.`booking_status`='approved' AND v.`vid`='" . $_SESSION['uid'] . "'";
