			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-center cl-effect-15">
						<li><a href="ArtistHome.php"  data-hover="Home">Home</a></li>
						<li><a href="ArtistViewRequests.php"  data-hover="Requests">Requests</a></li>
						<li><a href="ArtistViewBookings.php" data-hover="Bookings">Bookings</a></li>
						<li><a href="ArtistViewReviews.php"  data-hover="Reviews">Reviews</a></li>
						<li><a href="ArtistProfile.php" data-hover="Profile">Profile</a></li>
					</ul>
					<div class="clearfix"> </div>
				</div>
			</div> 
