                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style28">
                            <input type="text" value="Dancery" name="name" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style25">Total Payable Amount:</td>
                        <td class="auto-style26">
                            <span class="auto-style62"></span><input type="text"  value="500" name="name" />
            ...
            <td class="auto-style36"><fieldset><legend>Card Details</legend>
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <input type="text" name="cno" value="<?php echo $_SESSION["cardno"] ;?>"   style="font-weight: 700;"/>   </td>
                    </tr>
                </table>
                </fieldset></td>
...
if(isset($_REQUEST['sub'])){
 ...
 // echo "Shaaii".$name.$address.$email.$phone;
}
                    ?>
                    <tr>
                        <td >
                            <table class="auto-style1">
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text"  value="<?php if (!empty($name)){ echo $name;}?>" name="txtName" Width="300px" />
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style53" colspan="2">
                                       <input type="text" value="<?php if (!empty($address)){ echo $address;}?>" name="txtadrs" Width="300px" Height="43px" Width="300px" />
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style55" colspan="2">
                                        <input type="text" value="<?php if (!empty($email)){ echo $email;}?>" name="txtemail" Width="300px" Height="43px" Width="300px" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style56">5. *Phone</td>
                                    <td class="auto-style56">
                                       <input type="text" value="<?php if (!empty($phone)){ echo $phone;}?>" name="txtphon" Width="300px" Height="43px" Width="300px" />
                                    </td>
                                    <td class="auto-style56">
                                     <a href="Third.php">  <input type="button" value="Make Payment" name="pay"/></a>
