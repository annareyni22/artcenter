    ...
    <div style="margin: auto; width: 90%;">
	   ...
	   $_SESSION['aid']=$aid;
			...
			if ($conn->query($qry) == TRUE) {
				echo "<script>alert('booking Successfull');window.location='First.php'</script>";
			} else {
...
include ('user_register_db.php');
$qry="select * from artist_reg_table a,artist_portfolio p  where a.artist_id =p.artist_id"; 
