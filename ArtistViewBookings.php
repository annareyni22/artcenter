...
<div id="about" class="about">
	<div class="container">
		<h3 class="title wow fadeInUp animated" data-wow-delay=".5s">bookings</h3>

	</div>
	<div style="margin: auto; width: 80%;">
		<!-- ....................  -->
		<?php
		$qry = "SELECT * FROM `user_registration` u,`bookings` b,`artist_registration` a ,`artist_portfolio` p WHERE a.`aid`=p.`aid`AND a.`aid`=b.`aid` AND b.`uid`=u.`uid` AND   b.`booking_status`='approved' AND a.`aid`='" . $_SESSION['uid'] . "'";
